...
con-inspect:
	...
	@echo
		...
		docker inspect debian8_nodejs_1;
		@echo
		@echo Inspecting containers for debian7...
		docker inspect debian7_nodejs_1;
		@echo
		@echo Inspecting containers for centos7...
		docker inspect centos7_nodejs_1;
		@echo
		@echo Inspecting containers for centos6...
		docker inspect centos6_nodejs_1;
        else
		@echo Inspecting containers for $(DISTRO)...
		docker inspect $(DISTRO)_nodejs_1;
        endif
...
con-ips:
	...
	@echo
		...
		docker inspect debian8_nodejs_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for debian7...
		docker inspect debian7_nodejs_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos7...
		docker inspect centos7_nodejs_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos6...
		docker inspect centos6_nodejs_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        else
		@echo Showing IP addresses of containers for $(DISTRO)...
		docker inspect $(DISTRO)_nodejs_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        endif
